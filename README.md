...
(I copied the contents of this repository from The Odin Project, including the rest of this README file, to keep a reference to these exercises and my solutions.)
